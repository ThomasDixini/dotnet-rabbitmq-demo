...
{
    public class CustomerNotificationWorker(IConfiguration _configuration, ILogger<CustomerNotificationWorker> _logger, ConfirmatedScheduleHandler _confirmatedScheduleHandler) : BackgroundService
    {
